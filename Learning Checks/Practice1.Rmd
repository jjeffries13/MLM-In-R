...
```{r}
set.seed(13131)
dist_IDs <- sample(NE_EdSpending2$district_ID, 15, replace = F)

NE_EdSpending_random <- NE_EdSpending2 |> filter(district_ID %in% dist_IDs)
